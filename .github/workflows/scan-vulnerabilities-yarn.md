# scan-vulnerabilities-yarn

Kjører sikkerhetsscanning på Yarn/Node-prosjekter ved hjelp av CodeQL og Trivy. Denne workflowen bør kjøres regelmessig (f.eks. daglig eller ukentlig) for å oppdage sårbarheter i koden og avhengigheter.

Workflowen utfører to typer scanning:
- **CodeQL**: Statisk kodeanalyse som finner sikkerhetsproblemer i JavaScript/TypeScript-kode og GitHub Actions
...
- `package.json` med `yarn build` script
- `Dockerfile` i rot
